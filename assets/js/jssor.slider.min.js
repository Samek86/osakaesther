(function(h, e, b, i, c, g, j) { /*! Jssor */
    ...
    var d = h.$JssorEasing$ = { $EaseSwing: function(a) {
            return -b.cos(a * b.PI) / 2 + .5 }, $EaseLinear: function(a) {
            return a }, $EaseOutQuad: function(a) {
            return -a * (a - 2) }, $EaseGoBack: function(a) {
            return 1 - b.abs(2 - 1) }, $EaseInWave: function(a) {
            return 1 - b.cos(a * b.PI * 2) }, $EaseOutWave: function(a) {
            return b.sin(a * b.PI * 2) }, $EaseOutJump: function(a) {
    ...
    h.$JssorDirection$ = { $TO_LEFT: 1, $TO_RIGHT: 2, $TO_TOP: 4, $TO_BOTTOM: 8, $HORIZONTAL: 3, $VERTICAL: 12, $GetDirectionHorizontal: function(a) {
            return a & 3 }, $GetDirectionVertical: function(a) {
            return a & 12 }, $IsHorizontal: function(a) {
            return a & 3 }, $IsVertical: function(a) {
            return a & 12 } };
    var a = h.$Jssor$ = new function() {
        ...
        function Eb() {
            if (!L) { L = { $Touchable: "ontouchstart" in h || "createTouch" in e };
                var a;
                if (B.pointerEnabled || (a = B.msPointerEnabled)) L.$TouchActionAttr = a ? "msTouchAction" : "touchAction" }
            return L }
        ...
        function v(i) {
            if (!s) { s = -1;
                if (tb == "Microsoft Internet Explorer" && !!h.attachEvent && !!h.ActiveXObject) {
                    ...
                    l = e.documentMode || p } else if (tb == "Netscape" && !!h.addEventListener) {
                    var d = k.indexOf("Firefox"),
                        b = k.indexOf("Safari"),
                        g = k.indexOf("Chrome"),
                        c = k.indexOf("AppleWebKit");
                    if (d >= 0) { s = fb;
                        l = n(k.substring(d + 8)) } else if (b >= 0) {
                        var j = k.substring(0, b).lastIndexOf("/");
                        s = g >= 0 ? jb : kb;
                        l = n(k.substring(j + 1, b)) } else {
                        var a = /Trident\/.*rv:([0-9]{1,}[\.0-9]{0,})/i.exec(k);
                        if (a) { s = T;
                            l = p = n(a[1]) } }
                    if (c >= 0) A = n(k.substring(c + 12)) } else {
        ...
        function t(a) {
            if (!z) { m(["transform", "WebkitTransform", "msTransform", "MozTransform", "OTransform"], function(b) {
                    if (a.style[b] != j) { z = b;
                        return c } });
                z = z || "transform" }
            return z }
        ...
        function G(a) {
            try {
                return D(a) == "object" && !a.nodeType && a != a.window && (!a.constructor || {}.hasOwnProperty.call(a.constructor.prototype, "isPrototypeOf")) } catch (b) {} }
        ...
        f.$BrowserEngineVersion = function() {
            return p || l };
        f.$WebKitVersion = function() { v();
            return A };
        f.$Delay = vb;
        f.$Inherit = function(a, b) { b.call(a);
            return C({}, a) };

        function W(a) { a.constructor === W.caller && a.$Construct && a.$Construct.apply(a, W.caller.arguments) }
        f.$Construct = W;
        ...
        function r(a) {
            return a || h.event }
        f.$GetEvent = r;
        f.$EvtSrc = function(a) { a = r(a);
            return a.target || a.srcElement || e };
        f.$EvtTarget = function(a) { a = r(a);
            return a.relatedTarget || a.toElement };
        f.$EvtWhich = function(a) { a = r(a);
            return a.which || ([0, 1, 3, 0, 2])[a.button] || a.charCode || a.keyCode };
        f.$MousePosition = function(a) { a = r(a);
        ...
        function E(c, d, a) {
            if (a != j) c.style[d] = a;
                ...
                a = b[d];
                if (a == "" && h.getComputedStyle) { b = c.ownerDocument.defaultView.getComputedStyle(c, i);
                    b && (a = b.getPropertyValue(d) || b[d]) }
                return a } }

        function Y(b, c, a, d) {
            if (a != j) { d && (a += "px");
                E(b, c, a) } else return n(E(b, c)) }
        ...
        function Ab(b) {
            if (q() && p < 9) {
                ...
                return a ? n(a[1]) / 100 : 1 } else return n(b.style.opacity || "1") }
        ...
        function Bb(c, a, f) {
            if (q() && p < 9) {
                ...
                var g = I(h, [i], d);
                eb(c, g) } else c.style.opacity = a == 1 ? "" : b.round(a * 100) / 100 }
        ...
        function ab(e, a) {
            ...
            if (M()) {
                ...
                zb(e, !d && c == 1 ? i : l, f.$GetMatrixOffset(l, a.$OriginalWidth, a.$OriginalHeight)) } else {
                var g = t(e);
                if (g) {
        ...
        f.$SetStyleTransform = function(b, a) {
            if (cb()) vb(f.$CreateCallback(i, ab, b, a));
            else ab(b, a) };
        ...
        f.$DisableHWA = function(a) { a.style[t(a)] = "none" };
        var mb = 0,
            gb = 0;
        ...
        f.$MouseOverOutFilter = function(b, a) {
            return function(c) { c = r(c);
                var e = c.type,
                    d = c.relatedTarget || (e == "mouseout" ? c.toElement : c.fromElement);
                (!d || d !== a && !f.$IsChild(a, d)) && b(c) } };
        f.$AddEvent = function(a, c, d, b) { a = f.$GetElement(a);
        ...
        f.$RemoveEvent = function(a, c, d, b) { a = f.$GetElement(a);
        ...
        f.$FireEvent = function(c, b) {
            var a;
            if (e.createEvent) { a = e.createEvent("HTMLEvents");
                a.initEvent(b, g, g);
                c.dispatchEvent(a) } else {
                var d = "on" + b;
                a = e.createEventObject();
                c.fireEvent(d, a) } };
        f.$CancelEvent = function(a) { a = r(a);
            a.preventDefault && a.preventDefault();
            a.cancel = c;
            a.returnValue = g };
        f.$StopEvent = function(a) { a = r(a);
        ...
        f.$SelectElement = function(c) {
            ...
            var a = i;
            if (e.createRange) { a = e.createRange();
                a.selectNode(c) } else { a = e.body.createTextRange();
                a.moveToElementText(c);
                a.select() }
            b && b.addRange(a) };
        f.$DeselectElements = function() {
            if (e.selection) e.selection.empty();
            else h.getSelection && h.getSelection().removeAllRanges() };
        ...
        function Q(a, d, f, b) { b = b || "u";
            var c = [];
            for (a = a ? a.firstChild : i; a; a = a.nextSibling)
                if (a.nodeType == 1) { S(a, b) == d && c.push(a);
                    if (!f) {
                        var e = Q(a, d, f, b);
        ...
        function Z(b, c) {
            var a = "";
            m(c, function(c) { a && (a += b);
                a += c });
            return a }

        function H(a, c, b) { w(a, Z(" ", C(X(N(w(a)), N(c)), N(b)))) }
        f.$Join = Z;
        f.$AddClass = function(b, a) { H(b, i, a) };
        f.$RemoveClass = H;
        f.$ReplaceClass = H;
        f.$ParentNode = function(a) {
            return a.parentNode };
        f.$HideElement = function(a) { f.$CssDisplay(a, "none") };
        ...
        f.$ShowElement = function(a, b) { f.$CssDisplay(a, b ? "none" : "") };
        f.$ShowElements = function(b, c) {
            for (var a = 0; a < b.length; a++) f.$ShowElement(b[a], c) };
        f.$RemoveAttribute = function(b, a) { b.removeAttribute(a) };
        ...
        f.$GetNow = function() {
            return +new Date };
        f.$AppendChild = function(b, a) { b.appendChild(a) };
        f.$AppendChildren = function(b, a) { m(a, function(a) { f.$AppendChild(b, a) }) };
        f.$InsertBefore = function(b, a, c) {
            (c || a.parentNode).insertBefore(b, a) };
        f.$InsertAfter = function(b, a, c) { f.$InsertBefore(b, a.nextSibling, c || a.parentNode) };
        f.$InsertAdjacentHtml = function(b, a, c) { b.insertAdjacentHTML(a, c) };
        f.$RemoveElement = function(a, b) {
            (b || a.parentNode).removeChild(a) };
        f.$RemoveElements = function(a, b) { m(a, function(a) { f.$RemoveElement(a, b) }) };
        f.$Empty = function(a) { f.$RemoveElements(f.$Children(a, c), a) };
        ...
        function V(d, c, b) {
            var a = d.cloneNode(!c);!b && f.$RemoveAttribute(a, "id");
            return a }
        f.$CloneNode = V;
        f.$LoadImage = function(e, g) {
            var a = new Image;

            function b(e, c) { f.$RemoveEvent(a, "load", b);
        ...
        f.$LoadImages = function(d, a, e) {
            ...
            m(d, function(a) { f.$LoadImage(a.src, b) });
            b() };
        ...
        function Db(c) {
            ...
            function i() { H(c, p, d[g || k || h & 2 || h]) }

            function b() { k = 0;
                i();
                f.$RemoveEvent(e, "mouseup", b);
                f.$RemoveEvent(e, "touchend", b);
                f.$RemoveEvent(e, "touchcancel", b) }

            function n(a) {
                if (g) f.$CancelEvent(a);
                else { k = 4;
                    i();
                    f.$AddEvent(e, "mouseup", b);
                    f.$AddEvent(e, "touchend", b);
                    f.$AddEvent(e, "touchcancel", b) } }
            ...
            var l = a.$Split(w(c));
            if (l) o = l.shift();
            m(r, function(a) { d.push(o + a) });
            p = Z(" ", d);
            d.unshift("");
            f.$AddEvent(c, "mousedown", n);
            f.$AddEvent(c, "touchstart", n) }
        ...
        function J() {
            if (!u) u = C({ $MarginTop: f.$CssMarginTop, $MarginLeft: f.$CssMarginLeft, $Clip: f.$SetStyleClip, $Transform: f.$SetStyleTransform }, R);
            return u }
        ...
        f.$Cast = function(l, g, t, r, u, w, j) {
            ...
            if (l) { c = {};
                for (var f in g) {
                    ...
                    g[f];
                    var m = g[f];
                    if (a.$IsNumeric(m)) h = y + m * q;
                    else { h = a.$Extend({ $Offset: {} }, l[f]);
            ...
            if (g.$Clip && j.$Move) {
                ...
                c.$Clip.$Top -= o;
                c.$Clip.$Bottom -= o }
            if (c.$Clip && a.$CanClearClip() && !c.$Clip.$Top && !c.$Clip.$Left && c.$Clip.$Right == j.$OriginalWidth && c.$Clip.$Bottom == j.$OriginalHeight) c.$Clip = i;
            return c } };
    ...
    function l() {
        ...
        function i(a, b) { d.push({ $EventName: a, $Handler: b }) }

        function g(b, c) { a.$Each(d, function(a, e) { a.$EventName == b && a.$Handler === c && d.splice(e, 1) }) }

        function f() { d = [] }

        function e() { a.$Each(c, function(b) { a.$RemoveEvent(b.$Obj, b.$EventName, b.$Handler) });
            c = [] }
        b.$Listen = function(e, b, d, f) { a.$AddEvent(e, b, d, f);
            c.push({ $Obj: e, $EventName: b, $Handler: d }) };
        b.$Unlisten = function(e, b, d) { a.$Each(c, function(f, g) {
                if (f.$Obj === e && f.$EventName == b && f.$Handler === d) { a.$RemoveEvent(e, b, d);
                    c.splice(g, 1) } }) };
        b.$UnlistenAll = e;
        ...
        b.$TriggerEvent = function(b) {
            ...
            a.$Each(d, function(a) { a.$EventName == b && a.$Handler.apply(h, c) }) };
        b.$Destroy = function() { e();
            f();
            for (var a in b) delete b[a] } }

    function k(o, z, k, R, P, K) { o = o || 0;
        var e = this,
            s, O, p, q, x, B = 0,
            I, J, H, D, A = 0,
            l = 0,
            ...
            if (!E || x || i || l != d) {
                ...
                if (!E || x || i || g != n) {
                    if (K) {
                        ...
                        a.$Each(p, function(b, a) { C[a] && C[a](R, b) }) }
        ...
        function F(a, c, d) { c && a.$Locate(j, 1);
            if (!d) { f = b.min(f, a.$GetPosition_OuterBegin() + A);
        ...
        if (a.$IsBrowserSafari() && a.$BrowserVersion() < 7) t = i;
        t = t || function(b) { a.$Delay(b, k.$Interval) };
        ...
        function N(a) {
            if (s) { x = s = D = g;
                e.$OnStop();
                a && a() } }
        e.$Play = function(a, b, c) { v(a ? l + a : j, b, c) };
        e.$PlayToPosition = v;
        e.$PlayToBegin = function(a, b) { v(f, a, b) };
        e.$PlayToEnd = function(a, b) { v(j, a, b) };
        e.$Stop = N;
        e.$Continue = function(a) { v(a) };
        ...
        e.$GetPosition_Display = function() {
            return n };
        e.$GoToPosition = w;
        e.$GoToBegin = function() { w(f, c) };
        e.$GoToEnd = function() { w(j, c) };
        e.$Move = function(a) { w(l + a) };
        ...
        e.$IsOnTheWay = function() {
            return l > m && l <= u };
        e.$SetLoopLength = function(a) { r = a };
        e.$Locate = Q;
        e.$Shift = M;
        e.$Join = F;
        e.$Combine = function(a) { F(a, 0) };
        e.$Chain = function(a) { F(a, 1) };
    ...
    var n = h.$JssorSlideshowFormations$ = new function() {
        ...
        h.$FormationSwirl = function(q) {
            ...
            u = 0;
            while (u < w) { t = h + "," + b;
                if (b >= 0 && b < x && h >= 0 && h < y && !z[t]) { z[t] = c;
                    g(A, u++, [h, b]) } else switch (p[v++ % p.length]) {
                    case d:
                        b--;
                        break;
                    case f:
        ...
        h.$FormationZigZag = function(p) {
            ...
            u = 0;
            while (u < v) { y = c + "," + b;
                if (b >= 0 && b < w && c >= 0 && c < x && typeof t[y] == "undefined") { g(t, u++, [c, b]);
                    switch (h[s % h.length]) {
                        case d:
                            b++;
                            break;
    ...
    h.$JssorSlideshowRunner$ = function(o, s, q, t, y) {
        ...
        function m(h, f) {
            ...
            e.$GetBlocks = function(b, a) { b /= e.$Cols;
                a /= e.$Rows;
                var f = b + "x" + a;
                if (!e.$Blocks[f]) { e.$Blocks[f] = { $Width: b, $Height: a };
                    for (var c = 0; c < e.$Cols; c++)
                        for (var d = 0; d < e.$Rows; d++) e.$Blocks[f][d + "," + c] = { $Top: d * a, $Right: c * b + b, $Bottom: d * a + a, $Left: c * b } }
                return e.$Blocks[f] };
            if (e.$Brother) { e.$Brother = m(e.$Brother, f);
                e.$SlideOut = c }
            return e }
        ...
        function p(A, i, d, v, n, l) {
            ...
            a.$Each(o, function(i, m) { a.$Each(i, function(G) {
                    var K = G[0],
                        J = G[1],
                        v = K + "," + J,
                        o = g,
                    ...
                    if (I) {
                        if (d.$Clip) {
                            var w = d.$ScaleClip || 1,
                                i = t.$Offset = {};
                            if (C && z) { i.$Top = h.$Height / 2 * w;
                                i.$Bottom = -i.$Top } else if (C) i.$Bottom = -h.$Height * w;
                            else if (z) i.$Top = h.$Height * w;
                            if (B && A) { i.$Left = h.$Width / 2 * w;
                                i.$Right = -i.$Left } else if (B) i.$Right = -h.$Width * w;
                            else if (A) i.$Left = h.$Width * w }
                        r.$Clip = t;
                        f.$Clip = h[v] }
                    var L = o ? 1 : -1,
                        M = s ? 1 : -1;
                    ...
                    for (var F = 0; F <= D; F++) {
                        ...
                        j[v].push(E) } }) });
            o.reverse();
            a.$Each(o, function(b) { a.$Each(b, function(c) {
                    var f = c[0],
                        e = c[1],
                        d = f + "," + e,
                        b = i;
        ...
        f.$GetTransition = function() {
            ...
            c[a] && (c[a].$Index = a);
            return c[a] };
        f.$Initialize = function(w, x, i, k, a) { r = a;
            a = m(a, j);
            var g = k.$Item,
                d = i.$Item;
            g["no-image"] = !k.$Image;
        ...
        f.$GetProcessor = function() {
            ...
            if (e) a = new v;
            return a };
        if (a.$IsBrowserIe9Earlier() || a.$IsBrowserOpera() || y && a.$WebKitVersion() < 537) j = 16;
        l.call(f);
        k.call(f, -1e7, 1e7) };
    var f = h.$JssorSlider$ = function(q, fc) {
        ...
        function Dc() {
            ...
            a.$OnPositionChange = function(d, a) {
                ...
                if (e != a && a > d) e++;
                Tb(e, c);
                n.$TriggerEvent(f.$EVT_POSITION_CHANGE, t(a), t(d), a, d) } }

        function Cc() {
            var b = this;
            k.call(b, 0, 0, { $LoopLength: s });
            a.$Each(C, function(a) { D & 1 && a.$SetLoopLength(s);
                b.$Chain(a);
                a.$Shift(hb / bc) }) }
        ...
        function Bc() {
            var a = this,
                b = Sb.$Elmt;
            k.call(a, -1, 2, { $Easing: d.$EaseLinear, $Setter: { $Position: Zb }, $LoopLength: s }, b, { $Position: 1 }, { $Position: -2 });
            a.$Wrapper = b }
        ...
        function qc(m, l) {
            ...
            a.$OnStart = function() { P = c;
                T = i;
                n.$TriggerEvent(f.$EVT_SWIPE_START, t(y.$GetPosition()), y.$GetPosition()) };
            a.$OnStop = function() { P = g;
                j = g;
                var a = y.$GetCurrentSlideInfo();
                n.$TriggerEvent(f.$EVT_SWIPE_END, t(y.$GetPosition()), y.$GetPosition());!a.$Position && Fc(a.$VirtualIndex, r) };
            a.$OnPositionChange = function(g, f) {
                ...
                y.$GoToPosition(a) };
            a.$PlayCarousel = function(b, f, c, g) { d = b;
                e = f;
                h = c;
                y.$GoToPosition(b);
                a.$GoToPosition(0);
                a.$PlayToPosition(c, g) };
            a.$StandBy = function(d) { j = c;
                b = d;
                a.$Play(d, i, c) };
            a.$SetStandByPosition = function(a) { b = a };
            a.$MoveCarouselTo = function(a) { y.$GoToPosition(a) };
            y = new Dc;
            y.$Combine(m);
            y.$Combine(l) }
        ...
        function rc() {
            ...
            c.$Elmt = b;
            c.$AddClipElement = function(c) { a.$AppendChild(b, c);
                a.$ShowElement(b) };
            c.$Clear = function() { a.$HideElement(b);
                a.$Empty(b) } }

        function Ac(o, h) {
            var d = this,
                q, x, K, y, j, B = [],
                G, u, V, H, P, F, e, w, m, gb;
            k.call(d, -v, v + 1, { $SlideItemAnimator: c });

            function E(a) { x && x.$Revert();
                q && q.$Revert();
                U(o, a);
                F = c;
                q = new L.$Class(o, L, 1);
            ...
            function X() { q.$Version < L.$Version && E() }
            ...
            function N(o, r, m) {
                if (!H) { H = c;
                    if (j && m) {
                        ...
                        n.$TriggerEvent(f.$EVT_LOAD_END, h) } }
                a.$HideElement(r);
                o && o(d) }
            ...
            function bb(b) {
                if (b == T && r == h) {
                    if (!e) {
                        var a = i;
                        if (A)
                            if (A.$Index == h) a = A.$GetProcessor();
                            else A.$Clear();
                        X();
                        e = new xc(o, h, a, d.$GetCaptionSliderIn(), d.$GetCaptionSliderOut());
                        e.$SetPlayer(m) }!e.$IsPlaying() && e.$Replay() } }

            function S(f, c, g) {
                if (f == h) {
                    if (f != c) C[c] && C[c].$ParkOut();
                    else !g && e && e.$AdjustIdleOnPark();
                    m && m.$Enable();
                    var j = T = a.$GetNow();
                    d.$LoadImage(a.$CreateCallback(i, bb, j)) } else {
                    var l = b.abs(h - f),
                        k = v + p.$LazyLoading - 1;
                    (!P || l <= k) && d.$LoadImage() } }
            ...
            function cb() {
                if (r == h && e) { e.$Stop();
                    m && m.$Quit();
                    m && m.$Disable();
                    e.$OpenSlideshowPanel() } }

            function fb() { r == h && e && e.$Stop() }

            function Y(a) {!M && n.$TriggerEvent(f.$EVT_CLICK, h, a) }

            function O() { m = w.pInstance;
                e && e.$SetPlayer(m) }
            d.$LoadImage = function(d, b) { b = b || y;
                if (B.length && !H) { a.$ShowElement(b);
                    if (!V) { V = c;
                        n.$TriggerEvent(f.$EVT_LOAD_START, h);
                        a.$Each(B, function(b) {
                            if (!a.$Attribute(b, "src")) { b.src = a.$AttributeEx(b, "src2");
                                a.$CssDisplay(b, b["display-origin"]) } }) }
                    a.$LoadImages(B, j, a.$CreateCallback(i, N, d, b)) } else N(d, b) };
                ...
                if (A) {
                    ...
                    if (b) {
                        var e = T = a.$GetNow(),
                            c = h + Wb,
                            d = C[t(c)];
                        return d.$LoadImage(a.$CreateCallback(i, W, c, d, b, e), y) } }
                ab(r + p.$AutoPlaySteps * Wb) };
            d.$TryActivate = function() { S(h, h, c) };
            d.$ParkOut = function() { m && m.$Quit();
                m && m.$Disable();
                d.$UnhideContentForSlideshow();
                e && e.$Abort();
                e = i;
                E() };
            d.$StampSlideItemElements = function(a) { a = gb + "_" + a };
            d.$HideContentForSlideshow = function() { a.$HideElement(o) };
            d.$UnhideContentForSlideshow = function() { a.$ShowElement(o) };
            d.$EnablePlayer = function() { m && m.$Enable() };

            function U(b, e, d) {
                if (a.$Attribute(b, "jssor-slider")) return;
                d = d || 0;
                if (!F) {
                    if (b.tagName == "IMG") { B.push(b);
                        if (!a.$Attribute(b, "src")) { P = c;
                            b["display-origin"] = a.$CssDisplay(b);
                            a.$HideElement(b) } }
                    a.$IsBrowserIe9Earlier() && a.$CssZIndex(b, (a.$CssZIndex(b) || 0) + 1);
                    if (p.$HWA && a.$WebKitVersion())(a.$WebKitVersion() < 534 || !eb && !a.$IsBrowserChrome()) && a.$EnableHWA(b) }
                var f = a.$Children(b);
                a.$Each(f, function(f) {
                    var i = f.tagName,
                        k = a.$AttributeEx(f, "u");
                    if (k == "player" && !w) { w = f;
                        if (w.pInstance) O();
                        else a.$AddEvent(w, "dataavailable", O) }
                    if (k == "caption") {
                        if (!a.$IsBrowserIE() && !e) {
                            ...
                            e = c } } else if (!F && !d && !j) {
                        if (i == "A") {
                            if (a.$AttributeEx(f, "u") == "image") j = a.$FindChildByTag(f, "IMG");
                            else j = a.$FindChild(f, "image", c);
                            if (j) { G = f;
                                a.$SetStyles(G, R);
                                u = a.$CloneNode(G, c);
                                a.$CssDisplay(u, "block");
                                a.$SetStyles(u, R);
                                a.$CssOpacity(u, 0);
                                a.$Css(u, "backgroundColor", "#000") } } else if (i == "IMG" && a.$AttributeEx(f, "u") == "image") j = f;
                        if (j) { j.border = 0;
                            a.$SetStyles(j, R) } }
                    U(f, e, d + 1) }) }
            ...
            d.$Index = h;
            l.call(d);
            var D = a.$FindChild(o, "thumb", c);
            if (D) { d.$Thumb = a.$CloneNode(D);
                a.$RemoveAttribute(D, "id");
                a.$HideElement(D) }
            a.$ShowElement(o);
            y = a.$CloneNode(db);
            a.$CssZIndex(y, 1e3);
            a.$AddEvent(o, "click", Y);
            E(c);
            d.$Image = j;
            d.$Link = u;
            d.$Item = o;
        ...
        function xc(E, i, p, u, t) {
            ...
            function x() { a.$Empty(N);
                dc && j && o.$Link && a.$AppendChild(N, o.$Link);
                a.$ShowElement(N, !j && o.$Image) }
            ...
            b.$Replay = function() {
                ...
                if (!B && !P && !s && r == i) {
                    ...
                    if (a != e)
                        ...
                        g = d;
                        p = f.$EVT_ROLLBACK_START } else g = b.$GetPlayToPosition();
                    n.$TriggerEvent(p, i, a, l, h, d, e);
                    var k = Q && (!G || H);
                    if (a == e)(d != e && !(G & 12) || k) && o.$GoForNextSlide();
                    else(k || a != d) && b.$PlayToPosition(g, y) } };
            b.$AdjustIdleOnPark = function() { d == e && d == b.$GetPosition_Display() && b.$GoToPosition(h) };
            b.$Abort = function() { A && A.$Index == i && A.$Clear();
                var a = b.$GetPosition_Display();
                a < e && n.$TriggerEvent(f.$EVT_STATE_CHANGE, i, -a - 1, l, h, d, e) };
            b.$OpenSlideshowPanel = function(b) { p && a.$CssOverflow(jb, b && p.$Transition.$Outside ? "" : "hidden") };
            ...
            d = h + (a.$ParseFloat(a.$AttributeEx(E, "idle")) || pc);
            t.$Shift(d);
            b.$Combine(t);
        ...
        function ec(e) {
            if (!B && (H || !(G & 12)) && !z.$IsPlaying()) {
                var c = y.$GetPosition(),
                    a = b.ceil(E);
                if (e && b.abs(F) >= p.$MinDragOffsetToSlide) { a = b.ceil(c);
                    a += gb }
                if (!(D & 1)) a = b.min(s - v, b.max(a, 0));
                var d = b.abs(a - c);
                d = 1 - b.pow(1 - d, 5);
                if (!M && qb) z.$Continue(Kb);
                else if (c == a) { ub.$EnablePlayer();
                    ub.$TryActivate() } else z.$PlayCarousel(c, a, d * Ub) } }

        function Ib(b) {!a.$AttributeEx(a.$EvtSrc(b), "nodrag") && a.$CancelEvent(b) }

        function uc(a) { Yb(a, 1) }

        function Yb(b, d) { b = a.$GetEvent(b);
            var k = a.$EvtSrc(b);
            if (!K && !a.$AttributeEx(k, "nodrag") && vc() && (!d || b.touches.length == 1)) { B = c;
                Ab = g;
                T = i;
                ...
                cb = 0;
                gb = 0;
                n.$TriggerEvent(f.$EVT_DRAG_START, t(E), E, b) } }
        ...
        function Db(e) {
            if (B) { e = a.$GetEvent(e);
                ...
                if (e.type != "mousemove") {
                    var l = e.touches[0];
                    f = { x: l.clientX, y: l.clientY } } else f = a.$MousePosition(e);
                if (f) {
                    var j = f.x - vb,
                        k = f.y - wb;
        ...
        function ob() { sc();
            if (B) { B = g;
                ...
                z.$Stop();
                var b = y.$GetPosition();
                n.$TriggerEvent(f.$EVT_DRAG_END, t(b), b, t(E), E);
                G & 12 && Ob();
                ec(c) } }
        ...
        function kc(c) {
            if (M) { a.$StopEvent(c);
                var b = a.$EvtSrc(c);
                while (b && u !== b) { b.tagName == "A" && a.$CancelEvent(c);
        ...
        function Fc(a, b) { w = 0;
            oc(a);
            n.$TriggerEvent(f.$EVT_PARK, t(a), b) }

        function Tb(b, c) { yb = b;
            a.$Each(O, function(a) { a.$SetCurrentIndex(t(b), b, c) }) }
        ...
        function lc(a, c) {
            if (c)
                if (!D) { a = b.min(b.max(a + yb, 0), s - v);
                    c = g } else if (D & 2) { a = t(a + yb);
                c = g }
            ab(a, p.$SlideDuration, c) }

        function zb() { a.$Each(O, function(a) { a.$Show(a.$Options.$ChanceToShow <= H) }) }
        ...
        function jc() { R = { $Width: J, $Height: I, $Top: 0, $Left: 0 };
            a.$Each(U, function(b) { a.$SetStyles(b, R);
                a.$CssPosition(b, "absolute");
                a.$CssOverflow(b, "hidden");
                a.$HideElement(b) });
            a.$SetStyles(db, R) }

        function nb(b, a) { ab(b, a, c) }

        function ab(f, e, k) {
            if (Qb && (!B || p.$NaviQuitDrag)) { P = c;
                B = g;
                z.$Stop();
                if (e == j) e = Ub;
        ...
        n.$PlayTo = ab;
        n.$GoTo = function(a) { ab(a, 1) };
        n.$Next = function() { nb(1) };
        n.$Prev = function() { nb(-1) };
        n.$Pause = function() { Q = g };
        n.$Play = function() {
            if (!Q) { Q = c;
                C[r] && C[r].$TryActivate() } };
        n.$SetSlideshowTransitions = function(a) { p.$SlideshowOptions.$Transitions = a };
        n.$SetCaptionTransitions = function(b) { L.$CaptionTransitions = b;
            L.$Version = a.$GetNow() };
        ...
        function Gb(c, d) {
            ...
            if (!x) {
                ...
                a.$CssTop(x, 0);
                a.$CssLeft(x, 0);
                a.$CssWidth(x, a.$CssWidth(q));
                a.$CssHeight(x, a.$CssHeight(q));
                a.$SetStyleTransformOrigin(x, "0 0");
                a.$AppendChild(x, b);
                var h = a.$Children(q);
                a.$AppendChild(q, x);
                a.$Css(q, "backgroundImage", "");
                a.$Each(h, function(c) { a.$AppendChild(a.$AttributeEx(c, "noscale") ? q : b, c) }) }
            Y = c / (d ? a.$CssHeight : a.$CssWidth)(x);
            a.$CssScale(x, Y);
            var g = d ? Y * W() : c,
                f = d ? c : Y * kb();
            a.$CssWidth(q, g);
            a.$CssHeight(q, f);
            a.$Each(O, function(a) { a.$Relocate(g, f) }) }
        n.$ScaleHeight = n.$GetScaleHeight = function(b) {
            if (b == j) return a.$CssHeight(q);
            Gb(b, c) };
        ...
        n.$GetVirtualIndex = function(a) {
            ...
            if (c > v) {
                if (a - r > s / 2) a -= s;
                else if (a - r <= -s / 2) a += s } else a = r + c - d;
            return a };
        l.call(n);
        ...
        var ib = p.$PlayOrientation & 3,
            ...
            S = !p.$UISearchMode,
            x, u = a.$FindChild(q, "slides", S),
            db = a.$FindChild(q, "loading", S) || a.$CreateDiv(e),
            Jb = a.$FindChild(q, "navigator", S),
            cc = a.$FindChild(q, "arrowleft", S),
            ac = a.$FindChild(q, "arrowright", S),
            Hb = a.$FindChild(q, "thumbnavigator", S),
            nc = a.$CssWidth(u),
            mc = a.$CssHeight(u),
            R, U = [],
            wc = a.$Children(u);
        a.$Each(wc, function(b) {
            if (b.tagName == "DIV" && !a.$AttributeEx(b, "u")) U.push(b);
        ...
        a.$CssZIndex(u, a.$CssZIndex(u) || 0);
        a.$CssPosition(u, "absolute");
        jb = a.$CloneNode(u, c);
        a.$InsertBefore(jb, u);
        if (fb) { dc = fb.$ShowLink;
            sb = fb.$Class;
            eb = v == 1 && s > 1 && sb && (!a.$IsBrowserIE() || a.$BrowserVersion() >= 8) }
        ...
        var xb = u,
            ...
            lb = Fb.$Touchable,
            E, qb, Kb, tb;
        Fb.$TouchActionAttr && a.$Css(xb, Fb.$TouchActionAttr, ([i, "pan-y", "pan-x", "none"])[X] || "");
        Z = new Bc;
        if (eb) A = new sb(Sb, J, I, fb, lb);
        a.$AppendChild(jb, Z.$Wrapper);
        a.$CssOverflow(u, "hidden");
        N = Xb();
        ...
        Eb = new Cc;
        z = new qc(Eb, Z);
        if (X) { a.$AddEvent(u, "mousedown", Yb);
            a.$AddEvent(u, "touchstart", uc);
            a.$AddEvent(u, "dragstart", Ib);
            a.$AddEvent(u, "selectstart", Ib);
            a.$AddEvent(e, "mouseup", ob);
            a.$AddEvent(e, "touchend", ob);
            a.$AddEvent(e, "touchcancel", ob);
            a.$AddEvent(h, "blur", ob) }
        G &= lb ? 10 : 5;
        if (Jb && rb) { Pb = new rb.$Class(Jb, rb, W(), kb());
            O.push(Pb) }
        if (V && cc && ac) { V.$Loop = D;
            V.$DisplayPieces = v;
            Rb = new V.$Class(cc, ac, V, W(), kb());
            O.push(Rb) }
        if (Hb && bb) { bb.$StartIndex = p.$StartIndex;
            Nb = new bb.$Class(Hb, bb);
            O.push(Nb) }
        a.$Each(O, function(a) { a.$Reset(s, C, db);
            a.$On(m.$NAVIGATIONREQUEST, lc) });
        Gb(W());
        a.$AddEvent(u, "click", kc);
    ...
    h.$JssorBulletNavigator$ = function(d, D) {
        ...
        function x(a) { a != -1 && A[a].$Selected(a == n) }
        ...
        f.$SetCurrentIndex = function(a) {
            if (a != r) {
                ...
                x(d);
                x(c) } };
        f.$Show = function(b) { a.$ShowElement(d, b) };
        var B;
    ...
    h.$JssorArrowNavigator$ = function(b, f, j) {
        ...
        function n(a) { d.$TriggerEvent(m.$NAVIGATIONREQUEST, a, c) }

        function r(c) { a.$ShowElement(b, c || !j.$Loop && e == 0);
        ...
        d.$Relocate = function(i, d) {
            if (!s || h.$Scale == g) {
                ...
                if (h.$AutoCenter & 1) { a.$CssLeft(b, (e - q) / 2);
                    a.$CssLeft(f, (e - q) / 2) }
                if (h.$AutoCenter & 2) { a.$CssTop(b, (d - o) / 2);
                    a.$CssTop(f, (d - o) / 2) }
                s = c } };
        var p;
        d.$Reset = function(d) { t = d;
            e = 0;
            if (!p) { a.$AddEvent(b, "click", a.$CreateCallback(i, n, -k));
        ...
        k = h.$Steps;
        if (h.$Scale == g) { a.$Attribute(b, "noscale", c);
            ...
            function h() {
                if (!s.$LastDragSucceded()) {
                    var a = e - f % e,
                        ...
                        c = b * e + e - a;
                    i.$TriggerEvent(m.$NAVIGATIONREQUEST, c) } }
            g.$Index = f;
            g.$Highlight = o;
            j = l.$Thumb || l.$Image || a.$CreateDiv();
            g.$Wrapper = b = a.$BuildElement(n, "thumbnailtemplate", j, c);
            k = a.$Buttonize(b);
            d.$ActionMode & 1 && a.$AddEvent(b, "click", h);
            d.$ActionMode & 2 && a.$AddEvent(b, "mouseover", a.$MouseOverOutFilter(h, b)) }
        i.$GetCurrentIndex = function() {
            return p };
        i.$SetCurrentIndex = function(c, d, f) {
            var a = p;
            p = c;
            a != -1 && v[a].$Highlight();
            v[c].$Highlight();!f && s.$PlayTo(s.$GetVirtualIndex(b.floor(d / e))) };
        i.$Show = function(b) { a.$ShowElement(k, b) };
        i.$Relocate = a.$EmptyFunction;
        var w;
        i.$Reset = function(F, D) {
            if (!w) { y = F;
                b.ceil(y / e);
                p = -1;
                o = b.min(o, D.length);
                ...
                a.$CssOverflow(h, "hidden");
                d.$AutoCenter & 1 && a.$CssLeft(h, (z - B) / 2);
                d.$AutoCenter & 2 && a.$CssTop(h, (x - n) / 2);
                a.$CssWidth(h, B);
                a.$CssHeight(h, n);
                var j = [];
                a.$Each(D, function(l, f) {
                    var g = new A(l, f),
                        d = g.$Wrapper,
                        c = b.floor(f / e),
                        k = f % e;
                    a.$CssLeft(d, (u + q) * k * (1 - i));
                    a.$CssTop(d, (t + r) * k * i);
                    if (!j[c]) { j[c] = a.$CreateDiv();
                        a.$AppendChild(h, j[c]) }
                    a.$AppendChild(j[c], d);
                    v.push(g) });
                var E = a.$Extend({ $HWA: g, $AutoPlay: g, $NaviQuitDrag: g, $SlideWidth: m, $SlideHeight: l, $SlideSpacing: q * i + r * (1 - i), $MinDragOffsetToSlide: 12, $SlideDuration: 200, $PauseOnHover: 1, $PlayOrientation: d.$Orientation, $DragOrientation: d.$DisableDrag ? 0 : d.$Orientation }, d);
                s = new f(k, E);
                w = c } };
        i.$Options = d = a.$Extend({ $SpacingX: 3, $SpacingY: 3, $DisplayPieces: 1, $Orientation: 1, $AutoCenter: 3, $ActionMode: 1 }, B);
        if (d.$Rows != j) d.$Lanes = d.$Rows;
        z = a.$CssWidth(k);
        x = a.$CssHeight(k);
        h = a.$FindChild(k, "slides", c);
        n = a.$FindChild(h, "prototype");
        u = a.$CssWidth(n);
        t = a.$CssHeight(n);
        a.$RemoveElement(n, h);
        e = d.$Lanes || 1;
    ...
    h.$JssorCaptionSlider$ = function(p, h, f) {
        var c = this,
            ...
            d = { $Default: function(b, a) {
                    if (!isNaN(a.$Value)) b = a.$Value;
                    else b *= a.$Percent;
                    return b }, $Opacity: function(b, a) {
        ...
        function l(r, m) {
            ...
            function g(f) {
                ...
                if (f == "*") h = p();
                    ...
                    if (a.$IsArray(d)) {
                        if (f != i) { i = f;
                            c[f] = 0;
                            j[f] = d[b.floor(b.random() * d.length)] } else c[f]++;
                        d = j[f];
                        if (a.$IsArray(d)) { d = d.length && d[c[f] % d.length];
            ...
            a.$Each(q, function(b) {
                ...
                a.$Each(f ? [0, 3] : [2], function(k, o) {
                    if (e) {
                        var j, f;
                        if (k != 2 || !a.$AttributeEx(b, "t3")) { f = h(b, k);
                            if (k == 2 && !f.$Transition) { f.$Delay = f.$Delay || { $Value: 0 };
                                f = a.$Extend(h(b, 0), f) } }
                        if (f && f.$Transition) { j = g(f.$Transition.$Value);
                            if (j) {
        ...
        function m(w, c, z) {
            ...
            if (c.$Zoom || c.$Rotate) { e.$Zoom = (c.$Zoom || 2) - 2;
                ...
                var s = { $Top: 0, $Right: l, $Bottom: j, $Left: 0 },
                    ...
                    q = c.$Clip & 2;
                if (u && p) { d.$Top = j / 2 * i;
                    d.$Bottom = -d.$Top } else if (u) d.$Bottom = -j * i;
                else if (p) d.$Top = j * i;
                if (t && q) { d.$Left = l / 2 * i;
                    d.$Right = -d.$Left } else if (t) d.$Right = -l * i;
        ...
        function i(b, d) { a.$Each(d, function(a) {
                var e, h = a.$Elmt,
                    d = a[0],
                    k = a[1];
                if (d) { e = m(h, d);
                ...
                e && c.$Combine(e) });
            return b }
        c.$Revert = function() { c.$GoToPosition(c.$GetPosition_OuterEnd() * (f || 0));
            g.$GoToPosition(0) };
        g = new k(0, 0);
        i(0, n ? l(p, 1) : []) };
